...
5. 安装libsndfile
    ...
    * Windows系统在<BlankLink href="http://www.mega-nerd.com/libsndfile/#Download">http://www.mega-nerd.com/libsndfile/#Download</BlankLink>下载。
    * 使用brew下载：
        ```bash
...
<Alert type="info"
  message={ [
    ...
    <div key="WebRTC_API" className="py-[8px]">
      ...
      <BlankLink href="https://stackoverflow.com/questions/13999790/python-audiolab-install-unable-to-install-or-find-libsndfile-on-mac-osx">
